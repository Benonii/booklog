    ...
    var ProfileService = _classThis = class {
        ...
        updateProfile(user_id, data) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (email) {
                    const existingEmail = yield this.prisma.user.findUnique({
                        where: { email }
                    });
                ...
                if (username) {
                    const existingUsername = yield this.prisma.user.findUnique({
                        where: { username },
                    });
                ...
                const updateUser = yield this.prisma.user.update({
                    where: { id },
                    data,
                });
                return {
